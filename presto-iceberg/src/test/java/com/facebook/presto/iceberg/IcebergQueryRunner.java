...
public final class IcebergQueryRunner
{
            ...
            throws Exception
    {
        ...
        if (externalWorkerLauncher.isPresent()) {
            queryRunnerBuilder.setExternalWorkerLauncher(externalWorkerLauncher);
        }
        ...
        if (catalogType == HIVE.name()) {
            Path icebergDir = icebergDataDirectory.resolve(TEST_DATA_DIRECTORY);
        ...
        switch (icebergCatalogType) {
            ...
            case HIVE:
                ...
                return ImmutableMap.of(
                        "hive.metastore", "file",
                        "hive.metastore.catalog.dir", testDataDirectory.toFile().toURI().toString());
        }
