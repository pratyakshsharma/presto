...
void to_json(json& j, const FileFormat& p);
void from_json(const json& j, FileFormat& p);
...
// dependency BaseHiveColumnHandle

namespace facebook::presto::protocol {

struct IcebergColumnHandle : public BaseHiveColumnHandle {
  ...
  bool operator<(const ColumnHandle& o) const override {
    return name < dynamic_cast<const IcebergColumnHandle&>(o).name;
  }
};
...
void to_json(json& j, const FileContent& p);
void from_json(const json& j, FileContent& p);
...
struct HiveColumnHandle : public BaseHiveColumnHandle {
  HiveType hiveType = {};
...
// dependency BaseHiveTableHandle
...
// dependency BaseHiveTableLayoutHandle
